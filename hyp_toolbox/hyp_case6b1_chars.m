function hyp_case6b1_chars(xCs,tCs,gCs,M,gamma,Nf,Ns,gs,gmin)
    % Draw characteristics for case 6b1
    ...
    g_lim = g2d;
    t_lim = t2d;
    gm2c = hyp_shockHeight(gamma,c1,c2,c3,c4,gm0,tm0,tm,g_lim,t_lim);
    gmF = gm2c;
    ...
    t2cRs(gs<gm2c) = hyp_shock(gamma,c1,c2,c3,c4,gm0,tm0,gs(gs<gm2c));
    ...
    t2dRs = zeros(size(gs));
    t2dRs(gm2c<gs) = hyp_shock(gamma,c1,c2,c3,c4,gm0,tm0,gs(gm2c<gs));
