function [xs,gs,xms,gms] = hyp_case0c_plume(xCs,tCs,gCs,M,gamma,Nf,Ns,t,gs,gmin)
    % Calculate plume shape for case 0c
    ...
    elseif t2a<t && t<=t2b
        ...
        % ... except left-moving waves that have been eaten by the peak
