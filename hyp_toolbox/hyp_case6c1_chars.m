function hyp_case6c1_chars(xCs,tCs,gCs,M,gamma,Nf,Ns,gs,gmin)
    % Draw characteristics for case 6c1
    ...
    t2dRs(gp2c<gs) = t2cRs(gp2c<gs);
    t2dRs(gs<g2d) = hyp_shock(gamma,c1,c2,c3,c4,gm0,tm0,gs(gs<g2d));
